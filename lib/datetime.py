...
def datetime_second_datetime_integer(second_from_reference,reference = '1970-01-01 00:00:00'):
	'''
	Thus module is to convert the time from second to integer datetime Year*1000+Month*100+day*1
	If the  time is given in hours, please convert it to seconds before being input into this module
