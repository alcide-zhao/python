...
file_path= '/exports/csce/datastore/geos/users/s1667168/CESM/extremes_indices/monsoon_index/'
...
ax1.plot(time,movingaverage(EASI_fixa),'-',color="blue",linewidth=2,label='FixA')
...
ax1=plt.subplot(spst[0],spst[1],5)
