...
def East_Asia_Monsoon_index(lon,lat,v850):
	region = [120,140,20,40]
	_,_,v850_clipped = range_clip(region[0],region[1],region[2],region[3],lon,lat,v850)
	EASI = stats.nanmean(stats.nanmean(v850_clipped,axis = 2),axis =1)
	return EASI
...
EASI = East_Asia_Monsoon_index(lon,lat,v_JJA_850)
...
# writting to nc file
#################################
file_name_out = file_path + 'CESM_fixa_Monsoon_index.nc'
