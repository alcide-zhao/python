...
index ='PRECC';	lon,lat,AEROSOL_c,Ene_c,Tech_c,AEROSOL_c_s,Ene_c_s,Tech_c_s = print_domain_mean(index);
index ='PRECL';	lon,lat,AEROSOL_l,Ene_l,Tech_l,AEROSOL_l_s,Ene_l_s,Tech_l_s= print_domain_mean(index);


ax = plt.subplot2grid((3, 7), (0, 0), colspan=3)
ax.annotate('Convective Precipitation',xy=(0.5,1.15), xytext=(0, pad),
...
colormesh0 = spatial_figure(ax,AEROSOL_c,AEROSOL_c_s,lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)

ax = plt.subplot2grid((3, 7), (0, 3), colspan=3)
ax.annotate('Large-scale Precipitation',xy=(0.5,1.15), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='center', va='baseline',rotation='horizontal',color='b',fontsize=15)
ax.annotate('(b)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)
colormesh0 = spatial_figure(ax,AEROSOL_l,AEROSOL_l_s,lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)
...
ax.annotate('(c)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)
x1 = np.reshape(np.nanmean(AEROSOL_c,axis=1),192)
x2 = np.reshape(np.nanmean(AEROSOL_l,axis=1),192)
x3 = np.reshape(np.nanmean(AEROSOL_c+AEROSOL_l,axis=1),192)
...
ax.annotate('Energy\nConsumption',xy=(-0.1,.5), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='center', va='center',rotation='vertical',fontsize=15)
spatial_figure(ax,Ene_c,Ene_c_s,lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)

ax = plt.subplot2grid((3, 7), (1, 3), colspan=3)
ax.annotate('(e)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)	
spatial_figure(ax,Ene_l,Ene_l_s,lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)

ax = plt.subplot2grid((3, 7), (1, 6), colspan=1)
ax.annotate('(f)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)
x1 = np.reshape(np.nanmean(Ene_c,axis=1),192)
x2 = np.reshape(np.nanmean(Ene_l,axis=1),192)
x3 = np.reshape(np.nanmean(Ene_c+Ene_l,axis=1),192)
plot_zonal_mean_uncertainty(ax,x1,x2,x3,lat,xlim=xlim)
...
ax.annotate('Technology\ndvancements',xy=(-0.1,.5), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='center', va='center',rotation='vertical',fontsize=15)	
spatial_figure(ax,Tech_c,Tech_c_s,lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)

ax = plt.subplot2grid((3, 7), (2, 3), colspan=3)
ax.annotate('(h)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)	
colormesh1 = spatial_figure(ax,Tech_l,Tech_l_s,lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)

ax = plt.subplot2grid((3, 7), (2, 6), colspan=1)
ax.annotate('(i)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)
x1 = np.reshape(np.nanmean(Tech_c,axis=1),192)
x2 = np.reshape(np.nanmean(Tech_l,axis=1),192)
x3 = np.reshape(np.nanmean(Tech_c+Tech_l,axis=1),192)
plot_zonal_mean_uncertainty(ax,x1,x2,x3,lat,xlim=xlim)
