...
emission='2010' #2010 or stag_tech stag_energy
specie='OC' 
Sectors = ['ENE','IND','SHIP','SWD','AGR','RCO','TRO','TNG','TRF','REF','PRO','OTH','CDS','CRS','LTO','SPS'] #'PPA',
...
for month in months:
	...
	file_out = file_path+emission+'/'+fn_op+'_'+specie+'_2010_'+str(month)+'_NUM_MOL.0.1x0.1.nc'
