...
def print_domain_mean(variable):
	...
	return lon,lat,Total,GHG,AEROSOL,StO3,TrO3,Total_s,GHG_s,AEROSOL_s,StO3_s,TrO3_s
...
fig = plt.figure(facecolor='White',figsize=[12,12]);pad= 5;
colorbar_min=-0.3;colorbar_max=0.3;colormap='BrBG';xlim=0.25

index ='PminusE';	lon,lat,Total,GHG_PmE,AEROSOL_PmE,StO3_PmE,TrO3_PmE,Total_PmE_s,GHG_PmE_s,AEROSOL_PmE_s,StO3_PmE_s,TrO3_PmE_s = print_domain_mean(index);
index ='LHFLX';	lon,lat,Total_E,GHG_E,AEROSOL_E,StO3_E,TrO3_E,Total_E_s,GHG_E_s,AEROSOL_E_s,StO3_E_s,TrO3_E_s= print_domain_mean(index);


ax = plt.subplot2grid((4, 7), (0, 0), colspan=3)
...
colormesh0 = spatial_figure(ax,GHG_E,GHG_E_s,lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)
ax = plt.subplot2grid((4, 7), (0, 3), colspan=3)
...
colormesh0 = spatial_figure(ax,GHG_PmE,GHG_PmE_s,lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)

ax = plt.subplot2grid((4, 7), (0, 6), colspan=1)
...
ax.annotate('(c)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)
x1 = np.reshape(np.nanmean(GHG_PmE,axis=1),192)
x2 = np.reshape(np.nanmean(GHG_E,axis=1),192)
x3 = np.reshape(np.nanmean(GHG_PmE+GHG_E,axis=1),192)
plot_zonal_mean_uncertainty(ax,x1,x2,x3,lat,xlim=xlim)


ax = plt.subplot2grid((4, 7), (1, 0), colspan=3)
...
ax.annotate('(d)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)
colormesh0 = spatial_figure(ax,AEROSOL_E,AEROSOL_E_s,lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)
ax = plt.subplot2grid((4, 7), (1, 3), colspan=3)
ax.annotate('(e)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)		

colormesh0 = spatial_figure(ax,AEROSOL_PmE,AEROSOL_PmE_s,lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)

ax = plt.subplot2grid((4, 7), (1, 6), colspan=1)
...
ax = plt.subplot2grid((4, 7), (2, 0), colspan=3)
...
ax.annotate('(g)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)	
colormesh1 = spatial_figure(ax,TrO3_E,TrO3_E_s,lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)
ax = plt.subplot2grid((4, 7), (2, 3), colspan=3)
ax.annotate('(h)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)	

spatial_figure(ax,TrO3_PmE,TrO3_PmE_s,lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)
ax = plt.subplot2grid((4, 7), (2, 6), colspan=1)
ax.annotate('(i)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)
x1 = np.reshape(np.nanmean(TrO3_PmE,axis=1),192)
x2 = np.reshape(np.nanmean(TrO3_E,axis=1),192)
x3 = np.reshape(np.nanmean(TrO3_PmE+TrO3_E,axis=1),192)
plot_zonal_mean_uncertainty(ax,x1,x2,x3,lat,xlim=xlim)


ax = plt.subplot2grid((4, 7), (3, 0), colspan=3)
...
ax.annotate('(j)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)	
spatial_figure(ax,StO3_E,StO3_E_s,lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)
ax = plt.subplot2grid((4, 7), (3, 3), colspan=3)
ax.annotate('(k)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)	

spatial_figure(ax,StO3_PmE,StO3_PmE_s,lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)

ax = plt.subplot2grid((4, 7), (3, 6), colspan=1)
ax.annotate('(l)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)
x1 = np.reshape(np.nanmean(StO3_PmE,axis=1),192)
x2 = np.reshape(np.nanmean(StO3_E,axis=1),192)
x3 = np.reshape(np.nanmean(StO3_PmE+StO3_E,axis=1),192)
plot_zonal_mean_uncertainty(ax,x1,x2,x3,lat,xlim=xlim)
