...
# colormap='BrBG';colorbar_min=-20;colorbar_max=20;

ax = plt.subplot(2,2,1);
ax.annotate('(a) Total effects',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=10)	
spatial_figure(ax,Total2010,Total2010_s,lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)
...
# cbar_ax = fig.add_axes([0.06, 0.03, 0.40, 0.015])
...
ax.annotate('(c) Aerosols',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=10)	
spatial_figure(ax,AEROSOL,AEROSOL_s,lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)
ax = plt.subplot(2,2,4);
ax.annotate('(d) Ozone',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='bottom',rotation='horizontal',fontsize=10)	
colormesh1=spatial_figure(ax,OZONE,OZONE_s,lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)
...
cbar_ax.annotate(r'$\mathrm{\mathsf{\Delta}\/mm\/day^{-1}}$',xy=(1.1,-1.1), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='center', va='bottom',rotation='horizontal',fontsize=15)
# cbar_ax.annotate(r'$\mathrm{\mathsf{\Delta}}$ %',xy=(1.05,-1.1), xytext=(0, pad),
                # xycoords='axes fraction', textcoords='offset points',
                # ha='center', va='bottom',rotation='horizontal',fontsize=15)			
plt.subplots_adjust(left=0.02, bottom=0.08, right=0.98, top=0.95, wspace=0.04, hspace=0.15); 
plt.savefig('./GHG_AEROSOL_OZONE/PRECP_Decompose_a.png', format='png', dpi=1000)
"""
...
ax.annotate('(a) Historical (2010 - 1970)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=10)	
spatial_figure(ax,AEROSOL,AEROSOL_s,lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)
...
cbar_ax = fig2.add_axes([0.10, 0.025, 0.70, 0.015])
...
# cbar_ax.annotate(r'$\mathrm{\mathsf{\Delta}\/mm\/day^{-1}}$',xy=(1.2,-0.9), xytext=(0, pad),
                # xycoords='axes fraction', textcoords='offset points',
                # ha='center', va='bottom',rotation='horizontal',fontsize=15)
...
plt.subplots_adjust(left=0.02, bottom=0.06, right=0.98, top=0.95, wspace=0.04, hspace=0.15); 
plt.savefig('./EDGAR3Scenario/prep_3scenarios_p.png', format='png', dpi=1000)
