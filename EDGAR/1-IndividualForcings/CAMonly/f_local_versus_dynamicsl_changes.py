...
def data_readin(variable,exp):	
	...
	if exp=='CamOnly':
		lon,lat,Edg70GO = data_netcdf(exp,'F_Edg70GO','FSNT');
		_,_,Ref1970 = data_netcdf(exp,'F_1970','FSNT');
		_,_,EdgRef = data_netcdf(exp,'F_EdgRef','FSNT');
		_,_,Edg70Oz = data_netcdf(exp,'F_Edg70Oz','FSNT');
		_,_,Edg70T10SOZ = data_netcdf(exp,'F_Edg70T10SOZ','FSNT');
	elif exp=='FullCp':
...
def spa_pat_reg_mean(variable):
	...
	Edg70Oz_d = Edg70Oz_T - Edg70Oz_F;
	Edg70GO_d = Edg70GO_T - Edg70GO_F;
	EdgRef_d = EdgRef_T - EdgRef_F;
	Edg70T10SOZ_d = Edg70T10SOZ_T - Edg70T10SOZ_F;
	...
	Dcomp = decompose_forcings(Ref970_d,Edg70GO_d,Edg70Oz_d,EdgRef_d,Edg70T10SOZ_d)
...
ax.annotate('Total response',xy=(0.5,1.2), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
...
ax.annotate('(c)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)		
colormesh1=spatial_figure(ax,fullCp[3,:,:],fullCp[8,:,:],lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)
...
ax.annotate('(d)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)		
colormesh1=spatial_figure(ax,fullCp[4,:,:],fullCp[9,:,:],lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)
...
ax.annotate('(e)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)	
ax.annotate('Local component',xy=(0.5,1.2), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='center', va='baseline',rotation='horizontal',fontsize=20)				
colormesh0 = spatial_figure(ax,Fcomp[1,:,:],Fcomp[6,:,:],lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)

ax = plt.subplot(4,3,5)
ax.annotate('(f)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)					
colormesh0 = spatial_figure(ax,Fcomp[2,:,:],Fcomp[7,:,:],lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)

ax = plt.subplot(4,3,8);
ax.annotate('(g)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)		
colormesh0 = spatial_figure(ax,Fcomp[3,:,:],Fcomp[8,:,:],lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)

ax = plt.subplot(4,3,11);
ax.annotate('(h)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)		
colormesh0 = spatial_figure(ax,Fcomp[4,:,:],Fcomp[9,:,:],lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)
...
ax.annotate('(i)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)	
ax.annotate('Dynamic component',xy=(0.5,1.2), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='center', va='baseline',rotation='horizontal',fontsize=20)				
colormesh0 = spatial_figure(ax,Dcomp[1,:,:],Dcomp[6,:,:],lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)

ax = plt.subplot(4,3,6)
ax.annotate('(j)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)					
colormesh0 = spatial_figure(ax,Dcomp[2,:,:],Dcomp[7,:,:],lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)

ax = plt.subplot(4,3,9);
ax.annotate('(k)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)		
colormesh0 = spatial_figure(ax,Dcomp[3,:,:],Dcomp[8,:,:],lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)

ax = plt.subplot(4,3,12);
ax.annotate('(l)',xy=(0.02,1.01), xytext=(0, pad),
                xycoords='axes fraction', textcoords='offset points',
                ha='left', va='baseline',rotation='horizontal',fontsize=15)		
colormesh0 = spatial_figure(ax,Dcomp[4,:,:],Dcomp[9,:,:],lon,lat,colormap,colorbar_min,colorbar_max,tb_lef=False,tb_bot=False)
...
plt.savefig(var+'_local_vs_dynamic.png', format='png', dpi=1000)
